...
<?php endif; ?>
            <div id='img'class="col-8 gap-3">
                        <img src="<?php echo e(url('assets/all/imgs/Logo.png')); ?>" alt="logo-Empresa">
                    </div>
<br>
    <div class="row">
        <div class="col-12">
...
<?php echo $__env->make('painel.templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projetos/blog/resources/views/painel/home/index.blade.php ENDPATH**/ ?>