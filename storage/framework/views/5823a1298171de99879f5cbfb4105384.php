...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo e(url('/painel/auxilios')); ?>">Auxilios </a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<div class="row">
        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption">
                        ...
                        <span class="caption-subject  sbold uppercase">Auxilios</span>
    ...
    <?php echo Form::open(['route' => 'cadGoComissaoAuxilio', 'class' => 'form form-search form-ds', 'files' => true]); ?>
...
<?php echo $__env->make('painel.templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cristiliano/dev/stdef/resources/views/painel/auxilios/index.blade.php ENDPATH**/ ?>