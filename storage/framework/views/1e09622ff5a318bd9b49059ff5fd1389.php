...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Relatórios de Auxílios</span>
        </li>
    </ul>
</div>
</div>
      ...
      <div class="col-12">
         <div class="card">
            <div class="card-header">
               <div class="card-header">
                  <?php echo Form::open(['route' => 'relatorios.pesquisarAuxilios']); ?>
                  ...
                  <div class="portlet-body">
                        ...
                        <table class="table table-hover table-light">
                            ...
                            <tr>                            
                                ...
                                <th width="75">AUX SAUDE ART 101 VI LC 169/21</th>
                                <th width="75">AUX ALIMENT ART 101 VI LC 169/21</th>
                                <th width="25">LINC COMPENSATORIA COORDENACAO</th>
                                <th width="25">LINC COMPENSATORIA PLANTAO JUDICIARIO</th>
                                <th width="25">LIC COMPENSATORIA 1 SUBSTITUICAO</th>
                                <th width="25">LIC COMPENSATORIA 2 SUBSTITUICAO</th>
                                <th width="25">DEFENSORIA DIGITAL</th>
                                <th width="25">MÊS</th>
                                <th width="25">ANO</th>
                            ...
                            <?php $__currentLoopData = $itens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iten): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>                                                                
                                    ...
                                    <td width="25">
                                        R$ <?php echo e(number_format($iten->aux_saude, 2, ',', '.')); ?>

                                    </td>
                                    <td width="25">
                                        R$ <?php echo e(number_format($iten->aux_aliment, 2, ',', '.')); ?>

                                    </td>
                                    <td width="75">
                                        R$ <?php echo e(number_format($iten->linc_comp_coordenacao, 2, ',', '.')); ?>

                                    </td>
                                    <td width="75">
                                        R$ <?php echo e(number_format($iten->linc_comp_plantao_judiciario, 2, ',', '.')); ?>

                                    </td>
                                    <td width="25">
                                        R$ <?php echo e(number_format($iten->lic_compensatoria_1, 2, ',', '.')); ?>

                                    </td>
                                    <td width="25">
                                        R$ <?php echo e(number_format($iten->lic_compensatoria_2, 2, ',', '.')); ?>

                                    </td>
                                    <td width="25">
                                        R$ <?php echo e(number_format($iten->defensoria_digital, 2, ',', '.')); ?>
...
<?php echo $__env->make('painel.templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cristiliano/dev/stdef/resources/views/painel/relatorios/auxilios.blade.php ENDPATH**/ ?>