                ...
                <div class="portlet-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-md-line-input form-md-floating-label blue-steel ">
                                    <?php echo Form::text('codigo_cliente', null, ['class' => 'form-control']); ?>
...
<?php echo $__env->make('painel.templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rafael/docker/pep/resources/views/painel/users/create-edit.blade.php ENDPATH**/ ?>