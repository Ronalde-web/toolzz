    ...
    <div class="col-md-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <a href="<?php echo e(route('permissoes.create')); ?>" class="btn btn-lg green-meadow ">
                        <i class="fa fa-plus"></i> Adicionar</a>
                </div>
                <div class="col-md-8 col-md-offset-1">


                    <?php echo Form::open(['route' => 'permissions.search', 'class'=>'form-horizontal']); ?>
                ...
                <table class="table table-hover table-light">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group ">
                                    <a href='<?php echo e(route('permissoes.edit', $v->id)); ?>' class="btn  btn-xs  blue">
                                        <i class="fa fa-edit"></i> Editar</a>
                                    <a href="<?php echo e(route('permissoes.show', $v->id)); ?>" class="btn btn-xs  red">
                                        <i class="fa fa-trash-o"></i> Deletar</a>
                                    <a href="<?php echo e(route('permissao.perfis', $v->id)); ?>" class="btn btn-xs  green-meadow ">
...
<?php echo $__env->make('painel.templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rafael/docker/portal pb/resources/views/painel/permissions/index.blade.php ENDPATH**/ ?>