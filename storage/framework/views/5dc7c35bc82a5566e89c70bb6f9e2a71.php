        ...
        <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li>
                <a href="<?php echo e(url('/painel/relatorios')); ?>" class="nav-link nav-toggle">
                    ...
                    <span class="title">Relatorio Folha</span>
                    <span class="arrow"></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('veiculos')): ?>
            <li>
                <a href="<?php echo e(url('/painel/relatorios-auxilios')); ?>" class="nav-link nav-toggle">
                    <i class="fa fa-cubes"></i>
                    <span class="title">Relatorio Auxílio</span>
                    <span class="arrow"></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li>
                <a href="<?php echo e(url('/painel/importacoes')); ?>" class="nav-link nav-toggle">
                    ...
                    <span class="title">Importar Folha</span>
                    <span class="arrow"></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('veiculos')): ?>
            <li>
                <a href="<?php echo e(url('/painel/auxilios')); ?>" class="nav-link nav-toggle">
                    <i class="fa fa-upload"></i>
                    <span class="title">Importar Auxílios</span>
                    <span class="arrow"></span>
                </a>
            </li>
            <?php endif; ?>
...
</div><?php /**PATH /home/cristiliano/dev/stdef/resources/views/painel/templates/siderbar.blade.php ENDPATH**/ ?>