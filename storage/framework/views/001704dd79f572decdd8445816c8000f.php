    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-5 col-12 p-5 overflow-y-scroll form-container position-relative" style="height: 100vh;">
                ...
                <div class="row mb-5">
                    <div class="col-8">
                        <img id="logo" src="<?php echo e(url('assets/all/imgs/Logo.png')); ?>" alt="logo-Empresa" class="img-fluid mb-3">
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 text-center">
                        <a href="<?php echo e(route('register' )); ?>" class="m-0 p-0">Criar conta</a>
                    </div>
                </div>
            </div>
        </div>
