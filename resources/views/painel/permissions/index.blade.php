    ...
    <div class="col-md-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <a href="{{route('permissoes.create')}}" class="btn btn-lg green-meadow ">
                        <i class="fa fa-plus"></i> Adicionar</a>
                </div>
                <div class="col-md-8 col-md-offset-1">


                    {!! Form::open(['route' => 'permissions.search', 'class'=>'form-horizontal']) !!}
                ...
                <table class="table table-hover table-light">
                    ...
                    @forelse($data as $v)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group ">
                                    <a href='{{route('permissoes.edit', $v->id)}}' class="btn  btn-xs  blue">
                                        <i class="fa fa-edit"></i> Editar</a>
                                    <a href="{{route('permissoes.show', $v->id)}}" class="btn btn-xs  red">
                                        <i class="fa fa-trash-o"></i> Deletar</a>
                                    <a href="{{route('permissao.perfis', $v->id)}}" class="btn btn-xs  green-meadow ">
