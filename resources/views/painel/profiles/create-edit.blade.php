...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/painel/perfis')}}">Perfis </a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
        ...
        <div class="col-md-12">
            <div class="portlet light portlet-fit portlet-form ">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-body">
                        @if( isset($data) )
                            {!! Form::model($data, ['route' => ['perfis.update', $data->id], 'class' => 'form form-search form-ds', 'files' => true, 'method' => 'PUT']) !!}
                        @else
                            {!! Form::open(['route' => 'perfis.store', 'class' => 'form form-search form-ds', 'files' => true]) !!}
                        @endif
                        <div class="row">
                            <div class="col-md-6">
